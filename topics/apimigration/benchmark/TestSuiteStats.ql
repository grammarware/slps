...
from Class testSuite, int testMethods, int assertions, boolean ignored
where 
  ...
  and (
		if (testSuite.getName() = "AttributeTest" or
			testSuite.getName() = "AttributesTest" or
			...
			testSuite.getName() = "CDATASectionTest" or
...
select ignored, testSuite, testMethods, assertions 