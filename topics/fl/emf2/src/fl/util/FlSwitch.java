...
public class FlSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FlPackage.APPLY: {
				Apply apply = (Apply)theEObject;
				T result = caseApply(apply);
				if (result == null) result = caseExpr(apply);
			...
			case FlPackage.ARGUMENT: {
				...
				if (result == null) result = caseExpr(argument);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlPackage.BINARY: {
				Binary binary = (Binary)theEObject;
				T result = caseBinary(binary);
				if (result == null) result = caseExpr(binary);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlPackage.DOCUMENT_ROOT: {
			...
			case FlPackage.IF_THEN_ELSE: {
				IfThenElse ifThenElse = (IfThenElse)theEObject;
				T result = caseIfThenElse(ifThenElse);
				if (result == null) result = caseExpr(ifThenElse);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlPackage.LITERAL: {
