...
The implementation is free of memory leaks, but valgrind shows ~16kb (allocated by the lexer generated by flex) als "still reachable" in the "LEAK SUMMARY". This seems to be a problem with flex, maybe someone knows how to fix this...
